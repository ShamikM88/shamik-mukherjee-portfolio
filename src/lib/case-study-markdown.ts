...
Not a second MVP sprint — MVP v1 already shipped and is in daily use. This is the next disciplined MoSCoW pass, scoped the same way round 1 was: foundational gaps first, everything deferred disclosed honestly rather than silently dropped.
