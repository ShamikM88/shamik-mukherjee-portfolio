      ...
      <div>
        ...
        <div className="mt-6 flex flex-col gap-4">
          {process.steps.map((step, i) => (
            <div
              key={step.title}
              className="flex gap-4 rounded-2xl border border-ink-200 bg-white p-5 dark:border-white/10 dark:bg-white/[0.03]"
            >
      ...
      <div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {decisions.items.map((item) => (
            <div
              key={item.title}
              className="flex flex-col gap-3 rounded-2xl border border-ink-200 bg-white p-5 dark:border-white/10 dark:bg-white/[0.03]"
            >
              <h3 className="font-display text-sm font-semibold text-ink-900 dark:text-white">{item.title}</h3>
