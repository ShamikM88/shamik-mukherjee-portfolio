        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
          {cards.map((card) => {
            ...
            <Link
              key={card.id}
              href={card.href}
              className={`group flex flex-col overflow-hidden rounded-2xl border border-ink-200 bg-white transition-all duration-200 hover:-translate-y-1 hover:shadow-card-hover dark:border-white/10 dark:bg-ink-900 dark:hover:border-white/25 ${accent.border}`}
            >
