      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-24">
        <div className="flex flex-col-reverse items-start gap-10 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-col items-start gap-6">
            ...
            <p className="max-w-xl text-balance font-display text-xl font-medium text-brand-700 dark:text-brand-400 sm:text-2xl">
              {identity.headline}
            </p>
          ...
          <div className="relative h-40 w-40 flex-shrink-0 overflow-hidden rounded-full border-4 border-white shadow-card-hover dark:border-ink-900 sm:h-52 sm:w-52">
            <Image
              src={identity.photo}
